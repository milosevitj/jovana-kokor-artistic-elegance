...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'about.p3': 'Ich trete in verschiedenen Formationen auf – solo, im Duo oder Trio sowie mit meiner Band JoyWanna & The Spicy Jam. Jede Besetzung hat ihren eigenen Charakter: mal intim und reduziert, mal energiegeladen, rhythmisch und voller Spielfreude.',
  ...
  en: {
    ...
    'about.p3': 'I perform in various formations – solo, as a duo or trio, and with my band JoyWanna & The Spicy Jam. Each lineup has its own character: sometimes intimate and stripped-back, sometimes energetic, rhythmic, and full of playful joy.',
